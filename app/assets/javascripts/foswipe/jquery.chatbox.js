(function($) {
  $.fn.chatbox = function(options) {
    ...
    var ChatBox = function(el, options) {
      var tpl = '<div title="" class="chatbox"><div title="" class="header"><p>Demo Bot</p><a title="close chat window" class="close_chatbox" href="#">X</a><a title="minimize chat window" class="minimize_chatbox" href="#">_</a><a title="maximize chat window" class="maximize_chatbox" href="#">‾</a></div><div title="Demo Bot" class="chat_area"></div><div class="chat_info"><p></p></div><div title="Type your message here" class="chat_message"><form action="/foswipe/user_chats" class="new_user_chat" id="new_user_chat" method="post"> <textarea id="user_chat_content" name="user_chat[content]" ></textarea><input name="commit" type="submit" value="Send"></form></div></div>';
      var self = this;
      this.el = el;
      this.$el = $(el);
